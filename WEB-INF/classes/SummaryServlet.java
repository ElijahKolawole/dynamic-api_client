...
@WebServlet("/summary")   // Configure the request URL for this servlet (Tomcat 7/Servlet 3.0 upwards)
public class SummaryServlet extends HttpServlet {
   static String currURL = "/summary";
...
// Print an HTML page as the output of the query
      out.println("<html>");
      out.println("<head>");
      out.println("<title> Quote-Journey : Summary</title>");
...
// out.println("<h1>--------------</h1>");
      ...
      out.println("<h2>Your Application Summary </h2>");
      out.println("<form action='/dynamic-api_client/quote' method='get' id='form'>");
      out.println("<fieldset>");
      out.println("<legend><h3><i>--Summary--</i></h3></legend>");
// <h4>1. State</h4>
...
//    <option value="null" selected>Select</option>
// </select><br><br>
      out.println("<button type='submit' value='Submit' onclick='goBack(currURL, newURL);return false;' id='prevBtn'>Previous</button>");
      out.println("<button type='submit' value='Submit' onclick='goForward(currURL, newURL);return false;' id='nextBtn'>Continue</button>");
      out.println("</fieldset>");
      out.println("</form>");
      out.println("</div>");
      out.println("</div>");

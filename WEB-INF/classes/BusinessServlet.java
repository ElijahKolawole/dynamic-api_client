...
@WebServlet("/business")   // Configure the request URL for this servlet (Tomcat 7/Servlet 3.0 upwards)
...
// Print an HTML page as the output of the query
      out.println("<html>");
      out.println("<head>");
      out.println("<title> Quote-Journey : Business</title>");
...
// out.println("<h1>--------------</h1>");
      ...
      out.println("<h2>Tell us more About Your Business </h2>");
      out.println("<form action='/dynamic-api_client/quote' method='get' id='form'>");
      out.println("<fieldset>");
      out.println("<legend><h3><i>--About Your Business--</i></h3></legend>");
// <h4>1. State</h4>
